...
public class Keys {
    ...
    public static final UniqueKey<WalletTrackSettlementNewRecord> KEY_WALLET_TRACK_SETTLEMENT_NEW_PRIMARY = Internal.createUniqueKey(WalletTrackSettlementNew.WALLET_TRACK_SETTLEMENT_NEW, DSL.name("KEY_wallet_track_settlement_new_PRIMARY"), new TableField[] { WalletTrackSettlementNew.WALLET_TRACK_SETTLEMENT_NEW.ID }, true);
}
