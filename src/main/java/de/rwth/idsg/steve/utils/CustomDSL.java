...
import de.rwth.idsg.steve.repository.JodaDateTimeConverter;
...
public final class CustomDSL {
    ...
    public static Field<DateTime> date(DateTime dt) {
        ...
        DataType<DateTime> jodaType = SQLDataType.TIMESTAMP
                .asConvertedDataType(new JodaDateTimeConverter());

        return date(DSL.val(dt, jodaType));
    }
