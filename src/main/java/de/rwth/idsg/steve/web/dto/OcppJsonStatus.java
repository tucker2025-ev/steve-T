...
public final class OcppJsonStatus {
    ...
    @JsonCreator
    public OcppJsonStatus(
            @JsonProperty("chargeBoxPk") int chargeBoxPk,
            @JsonProperty("chargeBoxId") String chargeBoxId,
            @JsonProperty("connectedSince") String connectedSince,
            @JsonProperty("connectionDuration") String connectionDuration,
            @JsonProperty("version") OcppVersion version,
            @JsonProperty("connectedSinceDT") DateTime connectedSinceDT
    ) {
