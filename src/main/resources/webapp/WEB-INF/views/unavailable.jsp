        ...
        <section>
            <span>
                ...
                <a class="tooltip" href="#">
                    ...
                    <span>
                        There can be multiple entries for a charge point. <br/>
                        This indicates that charge point has opened more than one actual connection.
                    </span>
                </a>
            </span>
        </section>
            ...
            <tbody>
                <c:forEach items="${chargePoints}" var="cp">
                    <tr>
                        ...
                        <td>${cp.version}</td>
                        <td data-sort-value="${cp.connectedSinceDT.millis}">${cp.connectedSince}</td>
                        <td>${cp.connectionDuration}</td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
